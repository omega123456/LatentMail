...
const electronAPI = {
  ...
  mail: {
    ...
    syncFolder: (accountId: string, folder: string) =>
      ipcRenderer.invoke('mail:sync-folder', { accountId, folder }) as Promise<IpcResponse>,
  ...
  system: {
    ...
    getIsMacOS: () => ipcRenderer.invoke('system:get-is-mac-os') as Promise<boolean>,
