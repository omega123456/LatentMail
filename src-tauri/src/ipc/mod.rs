...
pub fn register<R: Runtime>(builder: tauri::Builder<R>) -> tauri::Builder<R> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        crate::ai::commands::read_ai_configs,
        crate::ai::commands::set_ai_enabled,
        crate::ai::commands::set_ai_base_url,
        crate::ai::commands::set_ai_api_key,
        crate::ai::commands::clear_ai_api_key,
        crate::ai::commands::test_ai_connection,
        crate::ai::commands::list_ai_models,
        crate::ai::commands::select_ai_chat_model,
        crate::ai::commands::select_ai_embedding_model,
        crate::ai::commands::read_ai_index_status,
        ...
        crate::sync::commands::load_message_body,
